...
import com.picpaysimplificado.picpaysimplificado.repositores.UserRepositore;
...
public class UserService {
    @Autowired
    private UserRepositore repository;
    ...
    public org.apache.catalina.User findUserById(Long id) throws Exception{
